...
cd ${CURRDIR} || exit 1
curl -f --output ${DESTDIR}/node https://gitlab.edgecenter.io/edgesense-open/nodejs-binary/-/raw/node-v12.14.0-linux-arm64/node || exit 1
...
# advsc
curl -f --output ${DESTDIR}/advsc https://gitlab.edgecenter.io/edgesense-open/advsc-binary/-/raw/master/Debian9.9-rk3399/1.0.5/advsc || exit 1
